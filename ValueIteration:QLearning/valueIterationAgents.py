...
class ValueIterationAgent(ValueEstimationAgent):
    ...
    def runValueIteration(self):
        ...
        "*** YOUR CODE HERE ***"
        #max sum(transition proability * (immediate reward + discount * successor value))
    ...
    def computeQValueFromValues(self, state, action):
        ...
        for next, prob in self.mdp.getTransitionStatesAndProbs(state, action):
            ...
            total += prob * (reward + self.discount * self.values[next])
        return total
...
class AsynchronousValueIterationAgent(ValueIterationAgent):
    ...
    def runValueIteration(self):
        ...
        for i in range(self.iterations):
            if indexIt == numStates: 
                indexIt = 0
            state = states[indexIt] 
            indexIt+=1
